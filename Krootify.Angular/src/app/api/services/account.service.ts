...
import { UpdateEmailDto } from '../models/update-email-dto';
...
export class AccountService extends BaseService {
   ...
   */
  static readonly ApiAccountUpdatePasswordPostPath = '/api/Account/update-password';
   ...
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  apiAccountUpdatePasswordPost$Response(params?: {
    body?: UpdatePasswordDto
  }): Observable<StrictHttpResponse<void>> {

    const rb = new RequestBuilder(this.rootUrl, AccountService.ApiAccountUpdatePasswordPostPath, 'post');
    if (params) {
      rb.body(params.body, 'application/*+json');
    }
   ...
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  apiAccountUpdatePasswordPost(params?: {
    body?: UpdatePasswordDto
  }): Observable<void> {

    return this.apiAccountUpdatePasswordPost$Response(params).pipe(
      map((r: StrictHttpResponse<void>) => r.body as void)
    );
  }

  /**
   * Path part for operation apiAccountUpdateEmailPost
   */
  static readonly ApiAccountUpdateEmailPostPath = '/api/Account/update-email';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `apiAccountUpdateEmailPost()` instead.
   *
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  apiAccountUpdateEmailPost$Response(params?: {
    body?: UpdateEmailDto
  }): Observable<StrictHttpResponse<void>> {

    const rb = new RequestBuilder(this.rootUrl, AccountService.ApiAccountUpdateEmailPostPath, 'post');
    if (params) {
      rb.body(params.body, 'application/*+json');
    }
  ...
  /**
   * This method provides access to only to the response body.
   * To access the full response (for headers, for example), `apiAccountUpdateEmailPost$Response()` instead.
   *
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  apiAccountUpdateEmailPost(params?: {
    body?: UpdateEmailDto
  }): Observable<void> {

    return this.apiAccountUpdateEmailPost$Response(params).pipe(
      map((r: StrictHttpResponse<void>) => r.body as void)
    );
  }

  /**
   * Path part for operation apiAccountUpdatePhotoPost
   */
  static readonly ApiAccountUpdatePhotoPostPath = '/api/Account/update-photo';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `apiAccountUpdatePhotoPost()` instead.
   *
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  apiAccountUpdatePhotoPost$Response(params?: {
    body?: { 'Photo': Blob }
  }): Observable<StrictHttpResponse<void>> {

    const rb = new RequestBuilder(this.rootUrl, AccountService.ApiAccountUpdatePhotoPostPath, 'post');
    if (params) {
  ...
  /**
   * This method provides access to only to the response body.
   * To access the full response (for headers, for example), `apiAccountUpdatePhotoPost$Response()` instead.
   *
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  apiAccountUpdatePhotoPost(params?: {
    body?: { 'Photo': Blob }
  }): Observable<void> {

    return this.apiAccountUpdatePhotoPost$Response(params).pipe(
      map((r: StrictHttpResponse<void>) => r.body as void)
    );
  }
